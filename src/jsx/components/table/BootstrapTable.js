         ...
         <Row>
            ...
            <Col lg={12}>
               <Card>
                  ...
                  <Card.Body>
                     <div className="table-responsive">
                        <Table className="table-responsive-sm table-striped">
                           <thead>
                              <tr>
                                 <th>#</th>
                                 <th>Name</th>
            ...
            <Col lg={12}>
               <Card>
                  ...
                  <Card.Body>
                     <div className="table-responsive">
                        <Table className="header-border table-hover verticle-middle">
                           <thead>
                              <tr>
                                 <th scope="col">#</th>
            ...
            <Col lg={12}>
               <Card>
                  ...
                  <Card.Body>
                     <div className="table-responsive">
                        <Table className="table-bordered verticle-middle">
                           <thead>
                              <tr>
            ...
            <Col lg={12}>
               <Card>
                  ...
                  <Card.Body>
                     <div className="table-responsive">
                        <Table className="table-bordered table-striped verticle-middle">
                           <thead>
                              <tr>
                                 <th scope="col">Task</th>
                                 <th scope="col">Progress</th>
            ...
            <Col lg={12}>
               <Card>
                  ...
                  <Card.Body>
                     <div className="table-responsive">
                        <Table className="primary-table-bordered">
            ...
            <Col lg={12}>
               <Card>
                  ...
                  <Card.Body>
                     <div className="table-responsive">
                        <Table className="primary-table-bg-hover">
                           <thead>
                              <tr>
                                 <th scope="col">#</th>
                                 <th scope="col">First</th>
